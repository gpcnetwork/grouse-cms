...
def get_objects(bucket_name,subfolder)->dict:
    ...
    for file in request_files:
        path, filename = op.split(file['Key'])
...
def load_meta_pcornet_url(url:str,sheet:str,tbl_col:str,var_col:str,dtype_col:str)->list:
...
def amend_metadata(old:list,new:dict)->list:
    ...
    for key in new.keys():
        ...
        try:
            ...
            meta.append([key,'CHAR']) # data type char is more generalizable
    return(meta)
